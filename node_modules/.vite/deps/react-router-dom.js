            ...
            let res = await generateMiddlewareResponse(
              async (revalidationRequest, opts2 = {}) => {
                ...
                let result2 = await queryImpl(
                  ...
                  null,
                  "filterMatchesToLoad" in opts2 ? (_a = opts2.filterMatchesToLoad) != null ? _a : null : null,
...
function createRouterFromPayload({
  ...
  globalVar.__reactRouterRouteModules = (_a = globalVar.__reactRouterRouteModules) != null ? _a : {};
  populateRSCRouteModules(globalVar.__reactRouterRouteModules, payload.matches);
  let patches = /* @__PURE__ */ new Map();
  (_b = payload.patches) == null ? void 0 : _b.forEach((patch) => {
    var _a2;
...
function getManifestUrl(paths) {
  ...
  const globalVar = window;
  let basename = ((_a = globalVar.__reactRouterDataRouter.basename) != null ? _a : "").replace(
    /^\/|\/$/g,
    ""
  );
